...
if (have_posts()) : while (have_posts()) : the_post(); ?>
    <div class="jumbotron">
        ...
        <div class="row">
            <div class="ml-auto col-sm-4 col-lg-3 text-center text-sm-right">
                <a href="<?php the_field('twitter_widget_url'); ?>" class="twitter-follow-button"
                   data-show-count="false"
                   data-size="large">Follow @MKEHackerHours</a>
            </div>
            <div class="col-sm-4 col-lg-3 text-center mt-3 mt-sm-0">
                <a href="<?php the_field('meetup_url'); ?>" class="d-inline-flex">
                    <img src="<?php echo get_template_directory_uri() . '/img/meetup_logo.png'; ?>" alt="">
                </a>
            </div>
            <div class="mr-auto col-sm-4 col-lg-3 text-center mt-3 mt-sm-0 text-sm-left">
